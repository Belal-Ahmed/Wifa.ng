...
import com.storerepublic.wifaapp.helper.WorkaroundMapFragment;
import com.storerepublic.wifaapp.home.adapter.ItemEditImageAdapter;
...
import com.storerepublic.wifaapp.utills.CircularProgressBar;
...
public class EditAdPost extends AppCompatActivity implements OnMapReadyCallback,
        ...
        , RuntimePermissionHelper.permissionInterface, AdapterView.OnItemClickListener {
    ...
    TextView textViewUserName, textViewUserPhone, textViewLat, textViewLong, textViewLocation, textViewTitle,
            textViewadCountry, btnPostAd, bumpAdTV, featureAdTV, featureAdByPackages, Gallary, tv_done;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSelectPix.setOnClickListener(view -> runtimePermissionHelper.requestStorageCameraPermission(1));
